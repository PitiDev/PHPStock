...
<ol class="breadcrumb" style="margin-top: 100px">
  <li><a href="dashboard.php"><b>ໜ້າຫຼັກ</b></a></li>
  <li>Order</li>
  <li class="active">
  	<?php if($_GET['o'] == 'add') { ?>
  		Add Order
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label"><b>ວັນທີ່ສັ່ງ</b></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label"><b>ຊື່ລູກຄ້າ</b></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="ຊື່ລູກຄ້າ" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label"><b>ເບີໂທຕິດຕໍ່</b></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="ເບີໂທຕິດຕໍ່" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table table-bordered" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">ສີນຄ້າ</th>
			  			<th style="width:20%;"><b>ລາຄາສີນຄ້າ</b></th>
			  			<th style="width:15%;">ຈຳນວນສີນຄ້າ</th>			  			
			  			<th style="width:15%;">ລວມລາຄາທັງໝົດ</th>			  			
			  			<th style="width:10%;">ລົບລາຍການ</th>
			  		</tr>
			  	</thead>
			  	<tbody>
			  		<?php
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">ຈໍານວນເງິນຍ່ອຍ</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">ພາສີ 13%</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">ຈໍາ​ນວນ​ທັງ​ຫມົດ</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">ສ່ວນລົດ</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">ລວມ​ທັງ​ຫມົດ</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">ຈຳນວນເງີນຈ່າຍ</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">ຈໍານວນເງິນທີ່ຖືກຕ້ອງ</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">ປະເພດການຈ່າຍເງິນ</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType">
				      	<option value="">--ເລືອກປະເພດ--</option>
				      	<option value="1">ກວດເບິ່ງ</option>
				      	<option value="2">ເງິນສົດ</option>
				      	<option value="3">ບັດ​ເຄຣ​ດິດ</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">ສະຖານະການຊໍາລະເງິນ</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">--ເລືອກປະເພດ--</option>
				      	<option value="1">ຈ່າຍເງີນເຕັມຈຳນວນ</option>
				      	<option value="2">ເງິນ​ທີ່​ຈ່າຍ​ລ່ວງ​ຫນ້າ</option>
				      	<option value="3">ບໍ່ມີການຈ່າຍເງິນ</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
			  </div> <!--/col-md-6-->
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> ເພີ່ມລາຍການສີນຄ້າ </button>

			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> ບັນທືກ</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> ເລີ່ມຕົ້ນໃໝ່</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
