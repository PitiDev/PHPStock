...
<div class="row" style="margin-top: 100px">
	<div class="col-md-12">
		<ol class="breadcrumb">
		  ...
		  <li class="active"><b>ສີນຄ້າ</b></li>
		</ol>

		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> <b>ຈັດການສີນຄ້າທັງໝັດ</b></div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> <b>ເພີ່ມສີນຄ້າ</b> </button>
				</div> <!-- /div-action -->				
				
				<table class="table table-bordered" id="manageProductTable">
					<thead>
						<tr>
							<th style="width:10%;"><b>ຮູບພາບ</b></th>							
							<th><b>ຊື່ສີນຄ້າ</b></th>
							<th><b>ລາຄາ</b></th>							
							<th><b>ຈຳນວນ</b></th>
							<th><b>ຊື່ຍີຫໍ້</b></th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> <b>ເພີ່ມສີນຄ້າ</b></h4>
	      </div>
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="productStatus" name="productStatus">
				      	...
				      	<option value="2">ສີນຄ້າໝົດ</option>
				      </select>
				    </div>
	        </div> <!-- /form-group-->	         	        
	      </div> <!-- /modal-body -->
